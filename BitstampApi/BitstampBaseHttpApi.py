...
class BitstampBaseHttpApi:
    def __init__(self):
        self.base_url_v2 = 'https://www.bitstamp.net/api/v2'
        self.base_url_v1 = 'https://www.bitstamp.net/api'
        self.logger = logging.getLogger(__name__)

    def send_request(self, endpoint, method='GET', json_response=True, v2=True, **kwargs):
        """
        ...
        :param v2: True if the call should be done on the Bitstamp's API v2
